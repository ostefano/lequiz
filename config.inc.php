<?php
	...
	$q_dataset = "./examples/example.xls";
	$q_dataset_sheet = 0;
	$filename = './files/state.txt';
	$LF = (PHP_SAPI === 'cli') ? "\n" : "<br />";
	
	$i = 0;
	$default_t[$i++] = array( "name" => "Team 1", "score" => 0 );
	$default_t[$i++] = array( "name" => "Team 2", "score" => 0 );
	$default_t[$i++] = array( "name" => "Team 3", "score" => 0 );
	$default_t[$i++] = array( "name" => "Team 4", "score" => 0 );
	$default_t[$i++] = array( "name" => "Team 5", "score" => 0 );
